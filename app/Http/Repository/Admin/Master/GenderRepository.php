...
class GenderRepository{
    ...
    try {
        return Gender::where('is_deleted', '0')->get();  // Fetch only records where is_deleted is 0
    } catch (\Exception $e) {
        return $e;
    }
}
    ...
    public function deleteById($id)
{
    try {
        ...
        if ($gender) {
            ...
            $gender->is_active = '0'; // Assuming you want to deactivate it
            $gender->is_deleted = '1';    // Assuming you want to mark it as not new
            $gender->save();
