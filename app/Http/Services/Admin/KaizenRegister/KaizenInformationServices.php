<?php
namespace App\Http\Services\Admin\KaizenRegister;

use App\Http\Repository\Admin\VoterInformation\KaizenInformationRepository;
...
class KaizenInformationServices
{
    ...
    public function __construct() {
        $this->repo = new KaizenInformationRepository();
    }
