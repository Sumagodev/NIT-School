    ...
    <div class="main-panel">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="district" id="district">
                                                        ...
                                                        <?php if($district['location_id'] == $village_data['district_id']): ?> <?php echo 'selected'; ?> <?php endif; ?>>
        ...
        <script>
            $(document).ready(function() {
                getDistrictTaluka('<?php echo e($village_data['district_id']); ?>', '<?php echo e($village_data['parent_id']); ?>');
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\egs_tablet_watap\resources\views/admin/pages/area/edit-village.blade.php ENDPATH**/ ?>