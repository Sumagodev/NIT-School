                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="employee_number" id="employee_number"
                                                placeholder="Please Enter Your Employee Number" value="<?php echo e(old('employee_number')); ?>">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#submitButton').click(function(e) {
                    ...
                    if (EmployeeNumber !== '') {
                        $.ajax({
                            url: '<?php echo e(route('filter-employee')); ?>',
                            type: 'GET',
                            data: {
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel_new_work\resources\views/admin/pages/users/users-list.blade.php ENDPATH**/ ?>