...
<section class="about-school py-5">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <img src="<?php echo e(('public/assets/images/scholar.png')); ?>"
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <a href="<?php echo e(route('/aboutpage')); ?>" class="btn-readmore">Read More &rarr;</a>
                    </div>
        ...
        <div class="vision-container container-fluid d-none d-lg-block">
            <div class="vision-banner position-relative">
                <img src="<?php echo e(('public/assets/images/vision.png')); ?>" alt="Vision Banner"
        ...
        <div class="mission-container container-fluid d-none d-lg-block">
            <div class="mission-banner position-relative">
                <img src="<?php echo e(('public/assets/images/mission.png')); ?>" alt="Mission Banner"
                    class="img-fluid banner-image">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="vision-images">
                        <div class="circle-image">
                            <img src="<?php echo e(('public/assets/images/kids-studying.png')); ?>"
                                alt="Child Studying"
                    ...
                    <div class="col-lg-5">
                        <div class="mission-images">
                            <div class="circle-image large-circle">
                                <img src="<?php echo e(('public/assets/images/mission2.png')); ?>"
                                    alt="Child Learning"
            ...
            <div class="admission-banner">
                <div class="admission-container d-flex flex-row">
                    ...
                    <div class="admission-image col-6">
                        <img src="<?php echo e(('public/assets/images/admission-banner.png')); ?>"
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('/latestnewspage')); ?>" class="btn btn-custom">Read More &rarr;</a>
                    </div>
                </div>
...
<?php echo $__env->make('Front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cet_project\resources\views/Front/pages/home/home.blade.php ENDPATH**/ ?>