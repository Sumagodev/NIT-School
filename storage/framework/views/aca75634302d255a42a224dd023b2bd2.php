                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="aadhar_no" onkeyup="formatAadharNumber(this)"
                                                id="aadhar_no" placeholder="" value="<?php echo e(old('aadhar_no')); ?>">
                                            <?php if($errors->has('number')): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="district" id="district">
                                                ...
                                                <?php $__currentLoopData = $dynamic_district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(old('district') == $district['location_id']): ?>
                                                        <option value="<?php echo e($district['location_id']); ?>" selected>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="user_profile" id="user_profile" accept="image/*"
                                                value="<?php echo e(old('user_profile')); ?>"><br>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\voter_info_collection\resources\views/admin/pages/users/add-users.blade.php ENDPATH**/ ?>