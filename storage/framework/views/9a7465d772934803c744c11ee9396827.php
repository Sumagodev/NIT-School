...
<div class="container my-5 schedule-visit">
            <h2 class="text-center mb-5">SCHEDULE A VISIT</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="form-container p-4 rounded">
                        <h3
                            class="form-header text-center text-white py-2">Schedule
                            A Visit</h3>
                        <form>
                            <div class="row mb-3">
                                <div class="col-6">
...
<?php echo $__env->make('Front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cet_project\resources\views/Front/pages/home/schedulevisit.blade.php ENDPATH**/ ?>