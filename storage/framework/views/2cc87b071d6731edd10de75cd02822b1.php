            ...
            <div class="container-fluid">
                <div class="row mt-5">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <img src="<?php echo e(('public/assets/images/about1.png')); ?>" alt="School Image 1" class="about_img1">
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <img src="<?php echo e(('public/assets/images/about2.png')); ?>" class="about_us_school_css1" alt="School Image 2">
                        <img src="<?php echo e(('public/assets/images/about3.png')); ?>" class="about_us_school_css2" alt="School Image 3">
                    </div>
            ...
            <div class="container-fluid profile-section">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 text-center profile-image">
                        <img src="<?php echo e(('public/assets/images/president.png')); ?>"
            ...
            <section class="mt-5">
                ...
                <div class="principal_css mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <img src="<?php echo e(('public/assets/images/principal-icon.png')); ?>" height="93%;" width="140%;" class="principal_img_css" alt="Prof Gopal A. Wadnere" />
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="row text-center">
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="teacher-card">
                                    <img src="<?php echo e(('public/assets/images/teacher1.png')); ?>"
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="teacher-card">
                                    <img src="<?php echo e(('public/assets/images/teacher2.png')); ?>"
                                        class="img-fluid rounded-circle"
                                        alt="ABC Teacher">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="teacher-card">
                                    <img src="<?php echo e(('public/assets/images/teacher3.png')); ?>"
                                        class="img-fluid rounded-circle"
                                        alt="ABC Teacher">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="teacher-card">
                                    <img src="<?php echo e(('public/assets/images/teacher4.png')); ?>"
                                        class="img-fluid rounded-circle"
                                        alt="ABC Teacher">
                                    <h6 class="mt-2 fw-bold">ABC<br>
                                        Teacher</h6>
...
<?php echo $__env->make('Front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\NIT_School\resources\views/Front/pages/home/about.blade.php ENDPATH**/ ?>