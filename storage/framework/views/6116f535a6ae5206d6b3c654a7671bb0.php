                            ...
                            <div class="container">
                                <div class="col-md-12">
                                    <div class="row ">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $return_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dashboard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php if(in_array($dashboard['url'], $data_for_url)): ?>
                                                <div class="col-xl-3 col-lg-6">
                                                    <a href="<?php echo e(url($dashboard['url'])); ?>">
                                                        <div class="card"
                                                            ...
                                                            <div class="card-statistic-3 p-4">
                                                                ...
                                                                <div class="mb-4">
                                                                    <h6 class="mb-0 dash_card_title">
                                                                        <?php echo e(mb_substr($dashboard['permission_name'], 0, 18)); ?></h6>
                                                                </div>
                                                                <div class="row align-items-center mb-2 d-flex">
                                                                    <div class="col-8">
                                                                        <h2 class="d-flex align-items-center mb-0 dash_count">
                                                                            <?php echo e($dashboard['count']); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\voter_info_collection\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>