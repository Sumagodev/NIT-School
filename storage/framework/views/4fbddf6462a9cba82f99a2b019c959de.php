                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <form action="<?php echo e(route('filter-tablet-distribution-all-export')); ?>" method="POST" target="__blank">
                                                <?php echo csrf_field(); ?>
            ...
            $(document).ready(function() {
                ...
                $('#submitButton').click(function(e) {
                    ...
                    if (districtId !== '' || talukaId !== '' || villageId !== '') {
                        $.ajax({
                            url: '<?php echo e(route('filter-tablet-distribution-all')); ?>',
                            type: 'GET',
                            data: {
                                districtId: districtId,
                                talukaId: talukaId,
        ...
        <script>
            $(document).ready(function() {
                $('#submitExportButton').click(function(e) {
                    ...
                    if (districtId !== '' || talukaId !== '' || villageId !== '') {
                        $.ajax({
                            url: '<?php echo e(route('filter-tablet-distribution-all-export')); ?>',
                            type: 'POST',
                            data: {
                                districtId: districtId,
                                talukaId: talukaId,
...
// });
        ...
        <form method="POST" action="<?php echo e(url('/show-tablet-distribution')); ?>" id="showform">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\egs_tablet_watap\resources\views/admin/pages/TabletDistribution/list-tablet-distribution.blade.php ENDPATH**/ ?>