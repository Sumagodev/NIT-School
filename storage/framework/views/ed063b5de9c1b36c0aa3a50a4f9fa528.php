                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <img src="<?php echo e(asset('storage/all_web_data/images/userProfile/'. $user_detail->user_profile)); ?>"
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/sumagodemo/public_html/voter_info_collection/resources/views/admin/pages/users/show-users.blade.php ENDPATH**/ ?>