                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <form class="forms-sample" id="frm_register" name="frm_register" method="post" role="form"
                                action="{{ route('devision-achievement') }}" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="achivement_date" id="achivement_date"
                                                placeholder="date" value="{{ old('achivement_date') }}">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="section_id" id="section_id"
                                                placeholder="section id" value="{{ old('section_id') }}">
                            ...
                            <div class="col-12">
                                        ...
                                        <div class="table-responsive" style="overflow-x: auto;">
                                            <table id="" class="table table-bordered nowrap" style="width: 100%;">
                                                ...
                                                placeholder="" value="{{ old('machine_id') }}"></td>
                                                <td>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $(document).on('click', '.remove-row', function () {
                        ...
                        if ($('#dynamic-rows .row-item').length > 0) {
