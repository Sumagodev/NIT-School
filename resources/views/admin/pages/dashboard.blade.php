                                    ...
                                    <div class="row ">
                                            ...
                                            @if(session()->get('role_id')=='1')
                                                <div class="col-xl-3 col-lg-6">
                                                    <a href="{{ route('list-voter-information') }}">
                                                        <div class="card"
                                                                ...
                                                                <div class="row align-items-center mb-2 d-flex">
                                                                    <div class="col-8">
                                                                        <h2 class="d-flex align-items-center mb-0 dash_count">
                                                                            @if ($data_dashboard['count'] > 0)
                                                                                {{ $data_dashboard['count'] }}
                                                                            @else
                                                                            0
                                                                            @endif
                                                        ...
                                                        <div class="card"
                                                            ...
                                                            <div class="card-statistic-3 p-4">
                                                                ...
                                                                <div class="row align-items-center mb-2 d-flex">
                                                                    <div class="col-8">
                                                                        <h2 class="d-flex align-items-center mb-0 dash_count">
                                                                            @if ($data_dashboard['admin_count'] > 0)
                                                                            {{ $data_dashboard['admin_count'] }}
                                                                            @else
                                                                            0
                                                                            @endif
                                                                        </h2>
                                                        ...
                                                        <div class="card"
                                                            ...
                                                            <div class="card-statistic-3 p-4">
                                                                ...
                                                                <div class="row align-items-center mb-2 d-flex">
                                                                    <div class="col-8">
                                                                        <h2 class="d-flex align-items-center mb-0 dash_count">
                                                                            @if ($data_dashboard['admin_user_count'] > 0)
                                                                            {{ $data_dashboard['admin_user_count'] }}
                                                                            @else
                                                                            0
                                                                            @endif
                                                                        </h2>
