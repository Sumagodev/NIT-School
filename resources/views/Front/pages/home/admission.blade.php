...
<div class="container mt-5">
    ...
    <div class="admission-process-section mt-5">
      ...
      <div class="process-wrapper">
        <a href="{{ route('/onlineprocesspage') }}" class="process-btn">Online Process
          &#x25BC;</a>
        <a href="{{ route('/visitingschoolpage') }}" class="process-btn ms-3">Visiting The
          School
          &#x25BC;</a>
      </div>
    </div>
    ...
    <div id="board-container" class="board-container">
      <!-- Book Image -->
      <img src="{{('public/assets/images/book.png')}}" alt="Book" class="book">

      <!-- Bag Image -->
      <img src="{{('public/assets/images/bag.png')}}" alt="Bag" class="bag">

      <!-- Pencil Image -->
      <img src="{{('public/assets/images/pencil.png')}}" alt="Pencil" class="pencil">
