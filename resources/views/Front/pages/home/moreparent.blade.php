...
<div class="card mb-4 parents-container" style="border: none;">
            <div class="row g-0">
                <div class="col-md-12 col-lg-4">
                    <img src="{{ ('public/assets/images/more-for-parents2.png')}}" class="img-fluid" alt="...">
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-3 text-center">
                    <div class="safety-icon">
                        <img src="{{ ('public/assets/images/safety-icon.png')}}" alt="Safety Icon">
                    </div>
                </div>
    ...
    <section class="info-section py-5">
        <div class="container-fluid">
          <div class="row align-items-center">
            <!-- Left Side Image -->
            <div class="col-lg-4">
              <img src="{{ ('public/assets/images/more-for-parents3.png')}}" alt="Books Image" class="img-fluid left-image" />
            </div>
